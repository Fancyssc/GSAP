...
class QKFormer(nn.Module):
    ...
    def forward_features(self, x):
        ...
        # stage2_5 = getattr(self, f"stage2_5")
        # patch_embed2_5 = getattr(self, f"patch_embed2_5")
