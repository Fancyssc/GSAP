...
def spikf_baseline(pretrained=False, **kwargs):
    if pretrained:
        raise ValueError('No pretrained weights are provided for spikf_baseline')
    model = SpikformerModel(
        img_size_h=kwargs.get('img_size_h', kwargs.get('img_size', 128)),
        img_size_w=kwargs.get('img_size_w', kwargs.get('img_size', 128)),
        ...
        mlp_ratios=kwargs.get('mlp_ratios', 4),
...
def Spikformer(pretrained=False, **kwargs):
    ...
    return spikf_baseline(pretrained=pretrained, **kwargs)
