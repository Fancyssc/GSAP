"""Local backbone snapshot from cifar10/gsap/spiking.py."""
import torch
...
class GSAPAttention(nn.Module):
    def __init__(self, dim, feature_size=8):
        ...
        self.feature_lif = MultiStepLIFNode(tau=2.0, detach_reset=True, backend='torch')
        ...
        self.row_lif = MultiStepLIFNode(tau=2.0, detach_reset=True, backend='torch')
        ...
        self.gate_lif = MultiStepLIFNode(tau=2.0, v_threshold=0.5, detach_reset=True, backend='torch')
