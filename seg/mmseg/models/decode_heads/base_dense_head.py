...
class BaseDenseHead(BaseModule, metaclass=ABCMeta):
    ...
    def loss_and_predict(
        ...
        Returns:
            tuple: the return value is a tuple contains:
                ...
                - predictions (list[:obj:`InstanceData`]): det
    ...
    def predict(self,
        ...
        Returns:
            list[obj:`InstanceData`]: det results of each image
    ...
    def _predict_by_feat_single(self,
        ...
        Returns:
            :obj:`InstanceData`: det results of each image
            after the post process.
    ...
    def _bbox_post_process(self,
        ...
        Args:
            results (:obj:`InstaceData`): det instance results,
    ...
    def aug_test(self,
        ...
        Returns:
            list(obj:`InstanceData`): det results of the
